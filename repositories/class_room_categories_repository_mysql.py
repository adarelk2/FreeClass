...
class ClassRoomCategoriesRepositoryMysql(ClassRoomCategoriesRepository):
    ...
    def get_all(self) -> List[Dict[str, Any]]:
        return self.db.query("SELECT * FROM classroom_categories", ()) or []
    ...
    def get_with_filter(
        ...
        *,
        ...
        query = "SELECT * FROM classroom_categories"
        params: List[Any] = []
